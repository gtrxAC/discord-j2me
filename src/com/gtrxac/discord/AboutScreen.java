...
//#endif
        ...
        i.addElement(new AboutScreenItem("chair_senpai", Font.SIZE_SMALL, 0, false, true));
        addDeveloper(i, "microtegla", TRANSLATOR_HU, 2);
        ...
        i.addElement(new AboutScreenItem("TheMBTDev", Font.SIZE_SMALL, 0, false, true));
