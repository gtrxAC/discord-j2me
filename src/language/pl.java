...
public class pl implements Language {
    public pl() {}
    ...
    static final String[] strings = {
        ...
        "Oznacz wszystko jako przyeczytane",
        ...
        "Odśwież, żeby przeczytać nowe wiadomości",
        ...
        "Ten serwer proxy nie wspiera przesyłania plików",
        "Ten serwer proxy nie wspiera usuwania wiadomości",
        "Ten serwer proxy nie wspiera edytwowania wiadomości",
        ...
        "Nie znaleziono użytkownika. Spróbuj utworzyć konwersację z innego klienta.",
        ...
        "Nie zdefiniowano adresu URL CDN. Załączniki nie są dostępne.",
        ...
        "Naciśnij klawisz, aby przypisać go do funkcji:",
        ...
        "kopiowanie zawartości wiadomości",
        ...
        "Używaj tylko serwerów proxy, którym ufasz!",

        // Help message for finding your token. Shown in login screen above the token field.
        "Token możesz znaleźć przez narzędzia deweloperskie twojej przeglądarki (poszukaj pomocy online). Zalecane jest użycie multikonta.",
        ...
        // Status messages.
        "rozpoczął/ęła rozmowę",
        "zmienił/a nazwę grupy",
        "zmienił/a ikonę grupy",
        "przypiął/eła wiadomość",
        "dołączył/yła do serwera",
        "ulepszył/yła serwer",
        ...
        "ulepszył/yła serwer do poziomu ",
        ...
        "Wymagane aktywne połączenie z bramą",
        ...
        "Błąd bramy. Czy chcesz spróbować połączyć ponownie?",
        ...
        "Aplikacja musi być zamknięta zanim ten adres URL może zostać otwarty.",
        ...
        ")\n\nMożesz spróbować skopiować adres URL ręcznie do przeglądarki twojego urządzenia ",
