...
public class fi implements Language {
    public fi() {}
    ...
    static final String[] strings = {
        ...
        "Lue uusia viestejä valitsemalla Päivitä",
        ...
        "Tämä välityspalvelin ei tue tiedostojen lähetystä",
        "Tämä välityspalvelin ei tue viestien poistoa",
        "Tämä välityspalvelin ei tue viestin muokkausta",
        ...
        "Laite ei tue FileConnection-rajapintaa",
        ...
        "Käyttäjää ei löytynyt. Luo keskustelu toisesta laitteesta.",
        ...
        "Mediapalvelinta ei ole määritelty. Liitteet eivät ole saatavilla.",
        ...
        "Tämä näppäin on jo määritelty: ",

        // Title text shown in login screen.
        "Kirjaudu",

        // Proxy server warning message shown at the top of the login screen.
        "Käytä vain välityspalvelimia joihin luotat!",

        // Help message for finding your token. Shown in login screen above the token field.
        "Löydät tokenisi selaimesi kehitystyökaluista - voit hakea netistä apua. Toissijaisen tilin käyttö on suositeltavaa.",
        ...
        "Palvelimen osoite",
        "Mediapalvelimen osoite",
        "Socket-palvelimen osoite",
        null,
        ...
        "Tokenia ei ole määritelty",
        "Palvelimen osoitetta ei ole määritelty",
        ...
        // Status messages.
        "aloitti puhelun",
        "vaihtoi ryhmän nimeä",
        "vaihtoi ryhmän kuvaketta",
        "kiinnitti viestin",
        "liittyi palvelimelle",
        "nostatti palvelinta",
        ...
        ":",
        "/",  // for date it should be "." but that's easy to confuse for time
        "A",
        "I",
        ...
        "Tämä toiminto vaatii aktiivisen socket-yhteyden",
        ...
        "Socket-yhteys katkesi. Haluatko yhdistää uudelleen?",
