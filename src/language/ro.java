...
public class ro implements Language {
    public ro() {}
    ...
    static final String[] strings = {
        ...
        "Reîmprosp. pentru a citi mesaje noi",
        ...
        "Acest proxy nu suportă încărcarea atașamentelor",
        "Acest proxy nu suportă ștergerea mesajelor",
        "Acest proxy nu suportă editarea mesajelor",
        ...
        "Utliz. negăsit. Încearcă să creezi MD-ul de la un alt client.",
        ...
        "URL al CDN-ului nu a fost definit. Atașamentele nu sunt disponibile.",
        ...
        "Eroare în trimiterea fișierului: ",
        ...
        "Apăsați tasta de utilizat pentru:",
        ...
        "copia conținutul mesajului",
        "reîmprospătarea mesajelor",
        "revenire",
        ...
        "Această tastă este deja asociată cu ",

        // Title text shown in login screen.
        "Conectare",

        // Proxy server warning message shown at the top of the login screen.
        "Utilizați numai proxy-uri la care aveți încredere!",

        // Help message for finding your token. Shown in login screen above the token field.
        "Token-ul poate fi găsit din instrumentele de dezvoltare ale browser-ului (căutați ajutor online). Se recomandă utilizarea unui alt cont.",
        ...
        "Vă rugăm să introduceți tokenul dvs.",
        "Vă rugăm să specificați o adresă URL API",
        ...
        // Status messages.
        "a început un apel",
        "a schimbat numele grupului",
        "a schimbat pictograma grupului",
        "a fixat un mesaj",
        "a intrat server-ul",
        "a stimulat server-ul",
        ...
        "a stimulat server-ul la nivelul",
        ...
        "Necesită o conexiune gateway activă",
        ...
        "Eroare gateway. Doriți să vă reconectați?",
