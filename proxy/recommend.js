...
const versionDownloadLinks = {
    "midp2":                { version: "5.3.1", betaVersion: "5.4", target: "Symbian S60v3 and up", tls: "via system-level TLS", tlsLink: "s60" },
    "s40v3":                { version: "5.3.1", betaVersion: "5.4", target: "Nokia S40v3 and up" },
    "midp2_alt_tls":        { version: "5.3.1", betaVersion: "5.4", target: "Nokia S40v3 and up", tls: "via Java-based TLS", tlsLink: "s40", showJar: false },
    "phoneme_android":      { version: "5.3.1", betaVersion: "5.4", target: "phoneME", tls: true, file: "midp2_alt_tls", showJar: false },
    "sony_ericsson":        { version: "5.3.1", betaVersion: "5.4", target: "Sony Ericsson", tls: "via Java-based TLS", tlsLink: "se", file: "midp2_alt_tls", showJar: false },
    "nokia_128px":          { version: "5.3.1", betaVersion: "5.4", target: "Nokia S40v3 and up (128x160)" },
    "nokia_128px_tls":      { version: "5.3.1", betaVersion: "5.4", target: "Nokia S40v3 and up (128x160)", tls: "via Java-based TLS", tlsLink: "s40", showJar: false },
    "s60v2":                { version: "5.3.1", betaVersion: "5.4", target: "Symbian S60v2" },
    "s40v2":                { version: "5.2.2", betaVersion: null, target: "Nokia S40v2 (with 512 kB heap)" },
    "s40v2hi":              { version: "5.3.1", betaVersion: "5.4", target: "Nokia S40v2 (with 1 MB heap)" },
    "midp2_alt":            { version: "5.3.1", betaVersion: "5.4", target: "other MIDP2 devices" },
    "midp2_alt_recommend":  { version: "5.3.1", betaVersion: "5.4", target: "MIDP2", file: "midp2_alt" },
    ...
    "blackberry":           { version: "5.3.1", betaVersion: "5.4", target: "BlackBerry" },
